...
def run_step_02(
    ...
    if mode == "assisted":
        ...
        print("Abriendo calibración V10 de un cuadro: etiqueta únicamente características visibles...")
        ...
        from src.I_field_geometry.multiframe_calibration_wizard import (
            calibrate_video_multiframe_interactively,
        )

        calibration_path = output_directory / "field_calibration.json"
        print("Preparando calibración global V10 con líneas de varios cuadros...")
        calibrate_video_multiframe_interactively(
            video_path=video_path,
            output_path=calibration_path,
            field_width=field_canonical_width,
        ...
        calibration_path = output_directory / "field_hologram_calibration.json"
        print("Abriendo editor V11: acomoda el holograma y guarda keyframes de corrección...")
        calibrate_video_hologram_interactively(
            video_path=video_path,
            output_path=calibration_path,

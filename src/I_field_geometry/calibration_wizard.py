...
def calibrate_video_interactively(
    ...
    """Flexible V10 single-frame field annotation with backward-compatible semantic anchors.
    ...
    state = _WizardState()
    window = "FutBotMX V10 - anclas semanticas visibles"
    ...
    print(
        f"Calibración V10 guardada con {accepted.feature_count} ancla(s): "

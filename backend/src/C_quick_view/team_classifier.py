...
from src.C_quick_view.team_features import TeamFeature, extract_team_feature
...
class TeamClassifier:
    ...
    def _decorate(self, detection: dict[str, Any]) -> dict[str, Any]:
    ...
    def update(
        ...
        for detection in detections:
            if (
                ...
                output.append(self._decorate(detection))
            else:
